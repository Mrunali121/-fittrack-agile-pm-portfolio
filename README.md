...
| [`generate_burndown_chart.py`](generate_burndown_chart.py) | The actual Python script that produces the burndown chart — data and annotations are reproducible, not a static image |
| [`index.html`](index.html) / [`styles.css`](styles.css) / [`script.js`](script.js) | The project's live landing page, published via GitHub Pages |
